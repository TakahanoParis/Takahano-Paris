 ...
 */
UCLASS()
class ATPGameMode : public AGameMode
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION()
		void GetAllPlayerControllers(TArray<class ATPPlayerController*> &OutControllers);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Players", meta =(DisplayName = "Get All Player controllers" )  )
		void GetAllPlayerControllers_BP(TArray<class ATPPlayerController*> &OutControllers) { GetAllPlayerControllers(OutControllers); }
