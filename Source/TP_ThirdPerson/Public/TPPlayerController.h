...
/**
 *	@brief ATPPlayerController Class
 *	the base class for every player controller in Project centauri.
 */
UCLASS()
class TP_THIRDPERSON_API ATPPlayerController : public APlayerController, public ISaveableActorInterface, public ITeamInterface 
{
	GENERATED_BODY()
